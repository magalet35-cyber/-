...
(function() {
    ...
    // ==========================================
    const PHONE_GAP_RATIO = 0.15;  // 핸드폰용 여백 비율 (2.5버전과 동일)
